...
public class CustomerController {
    ...
    //    @Secured({"ROLE_ADMIN", "ROLE_CUSTOMER"}) - this is the old annotation, used in combination with @EnableGlobalMethodSecurity(securedEnabled = true)
//    @PreAuthorize("hasAnyRole('ADMIN', 'CUSTOMER')") -- replaced by authorities
    @PreAuthorize("hasAuthority('customer.read')")
    @GetMapping
